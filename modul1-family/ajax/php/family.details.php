...
$qQueryParent = "SELECT * FROM FAMILY WHERE PARENT = $id";
$resultQonP = mysql_query($qQueryParent) or die(mysql_error());

if(mysql_num_rows($resultQonC) == 0 && mysql_num_rows($resultQonP) == 0){ 
